...
if self.num_suites > 2 && self.num_suites <= self.max_num_suites - 2
    ...
    if isR2015bOrNewer
        ...
        % R2011b: "causes only graphics objects to refresh, if needed.
        % It does not allow callbacks to execute and does not
    ...
    if isR2015bOrNewer
        ...
        % R2011b: "causes figure windows and their children to update and
