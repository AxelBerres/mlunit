...
function test_no_change
    ...
    if ispc
        ...
        stack = struct(...
            'file', '/opt/mlunit/test/junit_provocation/test_junit_error.m', ...
            'name', 'test_that', ...
            'line', 15);
    end
...
function stack = loc_sample_stack()
    ...
    if ispc
        ...
        stackinfos = { ...
            '/opt/mlunit/src/assertions/mlunit_fail.m',                 'mlunit_fail',           34; ...
            '/opt/mlunit/src/assertions/assert_true.m',                 'assert_true',           30; ...
            '/opt/mlunit/test/junit_provocation/test_junit_error.m',    'test_that',             15; ...
            '/opt/mlunit/src/@function_test_case/run_test.m',           'run_test',              21; ...
            '/opt/mlunit/src/@mlunit_suite_runner/run_test.m',          'run_test',              50; ...
            '/opt/mlunit/src/@mlunit_suite_runner/run_suite.m',         'run_suite',             62; ...
            '/opt/mlunit/src/automation/recursive_test_run.m',          'runTestsuite',          73; ...
            '/opt/mlunit/src/automation/recursive_test_run.m',          'recursive_test_run',    36; ...
        };
    end
