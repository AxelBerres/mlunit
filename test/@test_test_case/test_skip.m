...
skip_msg = get_message_with_stack(results(1).skipped);
assert_equals('Test skipped during execution.', skip_msg(1:30));
...
skip_msg = get_message_with_stack(results(3).skipped);
assert_equals('Substantiated skip', skip_msg(1:18));
